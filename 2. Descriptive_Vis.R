...
plot(airquality) #scatterplot applies on num only
help(plot)
...
# Horizontal bar plot  --> column name is necessary
# horizontal and vertical(by default) bars are created
# main is chart title
...
help(par)
par(mfrow=c(3,3),mar=c(1,3,1,3),  las=0, bty="o")
